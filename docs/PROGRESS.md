...
| 2.2d | B10 conversation timeout, B14 shared Bot lifecycle | [x] | 2026-09-16 | | `ZF_CONV_TIMEOUT_MINUTES` (default 30, 0 = off); `wire_bots()`; `python-telegram-bot[job-queue]` locked. See `docs/BOT_AUDIT.md` §1d |
